 ...
 * WIFI Settings
 **************************/
const char* WIFI_SSID = "VNE-N41";
const char* WIFI_PWD = "34670000";
...
String OPEN_WEATHER_MAP_APP_ID = "2a207f5c0861b8109f33840d5d722c1f";
String OPEN_WEATHER_MAP_LOCATION = "Kirov,RU";
